        ...
        <footer className="flex flex-col gap-4 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
            ...
            <nav className="sm:ml-auto flex gap-4 sm:gap-6">
                {["Terms of Service", "Privacy", "FAQ"].map((item) => (
                    <Link key={item} className="text-xs hover:underline underline-offset-4" href="#">
                        {item}
                    </Link>
                ))}
            </nav>
            ...
            <div className="mt-4 sm:mt-0 sm:ml-auto">
                <form onSubmit={handleSubscribe} className="flex items-center">
                    ...
                    />
                    <button type="submit" className="bg-blue-500 text-white rounded-r-md p-2 text-xs hover:bg-blue-600">
                        Subscribe
                    </button>
                </form>
            </div>
