...
export function KeyFeatures() {
  const features = [
    {
      ...
      description:
        "Choose from a wide range of professionally designed templates to create a stunning storefront that resonates with your brand identity. ",
    },
    {
      iconType: "ShoppingCart",
      title: "Drag-and-Drop Design",
      description:
        "Easily design your store using our intuitive drag-and-drop interface.",
    },
    {
      iconType: "CreditCard",
      title: "Integrated Payments",
      description:
        "Simplify your transactions with secure and integrated payment options.",
    },
    {
      iconType: "Smartphone",
      title: "Mobile Responsive",
      description:
        "Ensure your store looks great on all devices, from desktops to smartphones.",
    },
  ];
  ...
  return (
    <div
      id="features"
      className="flex flex-col justify-center items-center w-full py-12 bg-gray-100"
    >
      <div className="container p-4 md:px-6 text-center">
        ...
        <div className="grid gap-8 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="bg-white shadow-md rounded-lg p-6 flex flex-col h-full transition-transform transform hover:scale-105"
            >
