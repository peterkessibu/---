                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            ...
                            {user ? (
                                <>
                                    ...
                                    <button onClick={handleSignOut} className="hover:text-blue-400 transition-colors">Sign Out</button>
                                </>
                            ) : (
                                <>
                                    <button onClick={handleSignUp} className="hover:text-blue-400 transition-colors">Sign Up</button>
                                    <button onClick={handleSignIn} className="hover:text-blue-400 transition-colors">Sign In</button>
                                </>
                            )}
            ...
            <nav className="bg-gray-100 shadow-md">
                <div className="container mx-auto px-4 py-2">
                    <ul className="flex space-x-4 overflow-x-auto">
                        <li><a href="#" className="text-gray-600 hover:text-gray-800 whitespace-nowrap">Home</a></li>
                        <li><a href="#" className="text-gray-600 hover:text-gray-800 whitespace-nowrap">Electronics</a></li>
                        <li><a href="#" className="text-gray-600 hover:text-gray-800 whitespace-nowrap">Accessories</a></li>
                        <li><a href="#" className="text-gray-600 hover:text-gray-800 whitespace-nowrap">Wearables</a></li>
                        <li><a href="#" className="text-gray-600 hover:text-gray-800 whitespace-nowrap">Special Offers</a></li>
                    </ul>
                </div>
            </nav>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {ecommerceItems.map(item => (
                        <div key={item.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                            <img src={`/placeholder.svg?height=200&width=300&text=${item.name}`} alt={item.name} className="w-full h-48 object-cover" />
                            <div className="p-4">
                ...
                {cart.length > 0 && (
                    <div className="mt-12 bg-white rounded-lg shadow-md p-6">
                        ...
                        <div className="mt-4 flex justify-between items-center">
                            <span className="text-xl font-semibold">Total: ${cart.reduce((sum, item) => sum + item.unitPrice, 0).toFixed(2)}</span>
                            <button
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <p className="text-sm">TechGear Store is your one-stop shop for all your tech needs. We offer a wide range of high-quality electronics and accessories at competitive prices.</p>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#" className="text-sm hover:text-blue-400 transition-colors">Shipping Information</a></li>
                        ...
                        <div>
                            ...
                            <p className="text-sm">Address: 123 Tech Street, Silicon Valley, CA 94000</p>
                        </div>
                    </div>
