    ...
    >
      ...
      <div>
        ...
        {errors.paymentMethods && (
          <p className="text-red-600">{errors.paymentMethods}</p>
        )}
      </div>
      <div>
        <fieldset>
          ...
          {deliveryServices.map((service) => (
            <div key={service.id} className="flex items-center">
              <input
                ...
                value={service.id}
                onChange={handleCheckboxChange}
                checked={formData.deliveryServices.includes(service.id)}
              />
        ...
        {errors.deliveryServices && (
          <p className="text-red-600">{errors.deliveryServices}</p>
        )}
      </div>
      <button
        type="submit"
